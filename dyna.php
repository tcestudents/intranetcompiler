...
function addMore1(a){
  ...
  $('#'+a+'').append('<div data-count="'+inps+'" id="'+a+inps+'" ><b>Test Case '+inps+a+inps+'</b><br/>Input<textarea name="'+i+'i'+inps+'" id="'+i+'i'+inps+'" class="col-sm-12" rows="3" required ></textarea>Output <textarea name="'+i+'o'+inps+'" id="'+i+'o'+inps+'" class="col-sm-12" rows="3" required >'+i+'o'+inps+'</textarea><br>Marks Alloted<input type="text" name="'+i+'m'+inps+'" id="'+i+'m'+inps+'" required><br><br><button type="button" name="remove" id=id="count'+inps+'" onclick="del_test(\''+a+inps+'\')" style="font-size:20px;font-weight:bold" class="btn btn-outline-danger btn_remove">DELETE TESTCASE</button><br></div>');
}

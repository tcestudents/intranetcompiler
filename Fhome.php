  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right ">
		...
		<li><a href="create.php">CREATE CONTEST</a></li>
...
$id=0;			if(isset($data)){
				...
				echo "<a href=\"Fq.php?message=$data[$id]\"><div class=\"col-*-* conname\">$data[$id] ($publish[$id])</div></a><br>";		
				$id=$id+1;
}}else{
	echo "No contests are published yet....";
}
?>

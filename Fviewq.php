...
<div class="container" style="background-color: #ffffff" id="tt">
	...
	<div class="form-group">
      ...
      <fieldset>
       ...
       <b> Question:</b><br>
		<textarea disabled name="question" id="question" rows=5 cols=5 ><?php echo $Qname ;?></textarea>
...
while ($row=mysqli_fetch_row($res))
{
		...
		<textarea disabled name="i[]" id="i[]" rows=5 cols=5 ><?php echo $ii;?></textarea><br><br>
        <b>Sample Output  <?php echo $j;?> </b>
		<textarea disabled name="o[]" id="o[]" rows=5 cols=5 ><?php echo $oo;?></textarea><br><br>
		<b>Mark Alloted</b>
		<textarea disabled name="m[]" id="m[]" rows=1 cols=5 ><?php echo $mm ;?></textarea>	<br><br>
		<?php
		}}}
		?>
...
<input type="button" style=" font-weight:bold;" name="submit" id="submit" class="btn btn-success" value="back" onclick="back()" />
	<br> 
